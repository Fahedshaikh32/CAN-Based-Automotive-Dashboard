...
void can_transmit(uint16_t msg_id, const uint8_t *data, uint8_t len);   // send CAN data
void can_receive(uint16_t *msg_id, uint8_t *data, uint8_t *len);   // receive CAN data
